...
Generic Vulkan attention execution must not be labeled FlashAttention compatibility until its semantics, supported shapes/types, dispatch, and validation are explicitly connected to DiffUser.cpp.