...
CUDA 11.4 is the default CUDA generation for JetPack 5.x. This directory tracks DiffUser.cpp support for the JetPack 5 platform variant at CUDA 11.4.

## Required DiffUser.cpp feature coverage
