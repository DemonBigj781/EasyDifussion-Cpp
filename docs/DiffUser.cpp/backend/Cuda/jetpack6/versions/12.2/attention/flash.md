...
CUDA 12.2 is the default CUDA generation for JetPack 6.x. DiffUser.cpp uses ggml CUDA `fattn`; no JetPack-specific Flash kernel was found. Eligibility is still determined by fattn's device/tensor dispatch.
