...
The stable-diffusion.cpp tree contains a `ggml-sycl` backend and the repository contains dedicated oneAPI/SYCL planning and validation work. This backend therefore must be tracked as a real DiffUser.cpp target rather than a hypothetical backend.
