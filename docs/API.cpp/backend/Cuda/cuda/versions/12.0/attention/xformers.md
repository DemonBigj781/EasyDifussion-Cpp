...
The common xFormers API surface is present, but the current implementation does not expose a usable CUDA xFormers kernel and reports unsupported. CUDA 12.0 does not change this.
