...
The repository's visual-token-selection FlexAttention sums host float attention, normalizes, thresholds, adaptive-max-pools, and expands a host mask. JetPack 5/CUDA 11.4 adds no device implementation.
