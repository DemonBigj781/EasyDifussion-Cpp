...
// Keep sdkit's HTTP-side model index out of the executable's dynamic symbol
// table. stable-diffusion.cpp also has an unrelated global ModelManager class;
// exporting both lets ELF symbol interposition bind calls to the wrong class.
#if defined(__GNUC__) || defined(__clang__)
class __attribute__((visibility("hidden"))) ModelManager {
#else
class ModelManager {
#endif
   public:
