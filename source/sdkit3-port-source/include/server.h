...
class Server {
   ...
   private:
    ...
    crow::response handleTxt2Video(const crow::request& req);
    crow::response handleImg2Video(const crow::request& req);
    ...
    crow::response generateVideo(const crow::json::rvalue& json_body, bool is_img2video);
