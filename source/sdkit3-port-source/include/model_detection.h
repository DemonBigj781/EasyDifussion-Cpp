...
// True when the file contains a diffusion model plus embedded conditioner or
// VAE tensors. Such checkpoints must stay on model_path when an external text
// encoder is supplied, otherwise their other embedded components are lost.
