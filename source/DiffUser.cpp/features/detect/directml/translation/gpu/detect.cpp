#include "detect.hpp"
#include "features/detect/directml/definition/gpu/detect.hpp"
#include <utility>
namespace edcpp::api::detect::directml::translation::gpu {
Result detect() {
    auto native = definition::gpu::detect();
    Result result;
    result.backend = Backend::directml;
    result.backend_name = "directml";
...
[[maybe_unused]] const bool registered =
    edcpp::api::detect::register_translation(Backend::directml, &detect);
} // namespace edcpp::api::detect::directml::translation::gpu
