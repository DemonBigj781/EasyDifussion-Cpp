#pragma once
#include "detect.hpp"
#include "features/detect/openvino/definition/detect.hpp"
#include <utility>

namespace edcpp::api::detect::openvino::translation::detail {
inline Result translate(definition::NativeResult native, DeviceClass device_class) {
    Result result;
    result.backend = Backend::openvino;
    result.backend_name = "openvino";
