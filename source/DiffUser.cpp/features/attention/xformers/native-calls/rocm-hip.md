...
The actual DiffUser.cpp integration should document whether errors are converted to Common status, assertions, diagnostics, or backend failure codes.
...
- exact stream/context object passed from ggml/DiffUser.cpp;
