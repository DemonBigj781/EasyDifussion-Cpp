...
MODEL_EXTENSIONS = {
    ...
    "gfpgan": [".pth"],
    # stable-diffusion.cpp identifies the container by its contents and can
    # load ESRGAN weights from Torch, SafeTensors, or GGUF containers.
    "realesrgan": [".pth", ".pt", ".safetensors", ".sft", ".gguf", ".ckpt"],
