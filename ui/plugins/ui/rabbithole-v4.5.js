/* Easy Diffusion 4.5 Rabbit Hole entry point. */
(function () {
    "use strict"
    ...
    window.__easyDiffusionRabbitHoleRequestedVersion = "4.5"
    ...
    script.addEventListener("error", () => {
        ...
        console.error("Rabbit Hole 4.5 implementation could not be loaded.")
    })
