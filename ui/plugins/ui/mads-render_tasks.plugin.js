...
`;
    ...
    (function() {
        ...
        popupContainer.innerHTML = `
            ...
            <label for="${ID_PREFIX}-diffusion_model">Model:</label> <input id="${ID_PREFIX}-diffusion_model" type="text" spellcheck="false" autocomplete="off" class="model-filter model-selector" style="width: 280px;"><br>
            <label for="${ID_PREFIX}-vae_model">Custom VAE:</label> <input id="${ID_PREFIX}-vae_model" type="text" spellcheck="false" autocomplete="off" class="model-filter model-selector" style="width: 280px;"><br>
            <label for="${ID_PREFIX}-sampler_name">Sampler:</label><br>
            <label for="${ID_PREFIX}-scheduler_name">Scheduler:</label><br>
