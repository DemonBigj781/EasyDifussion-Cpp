...
_MOCKED_MODULES = (
    "sdkit", "sdkit.utils", "torchruntime", "torchruntime.utils",
    "easydiffusion", "easydiffusion.app", "easydiffusion.model_manager", "common",
)
...
def _install_mock_dependencies():
    ...
    easydiffusion_model_manager.resolve_model_to_use = lambda model, model_type: model
    ...
    sys.modules.update({
        "sdkit": sdkit, "sdkit.utils": sdkit_utils,
        "torchruntime": torchruntime, "torchruntime.utils": torchruntime_utils,
        "easydiffusion": easydiffusion, "easydiffusion.app": easydiffusion_app,
        "easydiffusion.model_manager": easydiffusion_model_manager, "common": common,
    })
...
class TestWebuiFaceFilterPayloads(unittest.TestCase):
    ...
    def test_face_only_filters_do_not_trigger_implicit_upscale(self):
        test_cases = (
            ...
            ("codeformer", ["codeformer"], {"codeformer": {"codeformer_fidelity": 0.35}}, {"codeformer_visibility": 1, "codeformer_weight": 0.35}),
        )
        for name, filters, filter_params, expected_payload in test_cases:
            with self.subTest(filter_name=name):
                ...
                images = self.webui_common.filter_images(None, ["input-image"], filters, filter_params, input_type="base64")
    ...
    def test_explicit_upscale_settings_are_still_forwarded(self):
        ...
        images = self.webui_common.filter_images(
            None, ["input-image"], ["gfpgan", "realesrgan"],
            {"gfpgan": {}, "realesrgan": {"upscaler": "RealESRGAN_x4plus", "scale": 4}}, input_type="base64",
        )
